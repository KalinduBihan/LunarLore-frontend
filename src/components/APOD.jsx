...
const Apod = () => {
  ...
  return (
    <div id="apod">
      ...
      <div className="sm:mx-1 mx-1 grid grid-cols-1 gap-0 sm:grid-cols-12 bg-gray-950">
        <div className="min-h-[400px] rounded-lg sm:col-span-5 flex items-center justify-center text-center">
          <motion.aside
            initial={{ opacity: 0, y: 30 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.4 }}
        ...
        <div className="min-h-[400px] sm:col-span-7 ">
          {nasaApod && (
