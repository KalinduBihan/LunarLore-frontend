...
const NewsCard = ({ img, title, description, link }) => {
  return (
    <div className="news__card lg:max-w-6xl lg:mx-auto lg:flex shadow-[rgba(0, 0, 0, 0.24), 0px 3px 8px;]">
      ...
      <div className="card__body bg-white rounded-es-2xl rounded-ee-2xl lg:rounded-es-none lg:rounded-se-2xl px-3 py-6 text-black text-center lg:text-start lg:p-6 lg:flex lg:flex-col lg:justify-center">
        <h3 className="card__title text-2xl font-semibold">{title}</h3>
